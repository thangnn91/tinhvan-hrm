...
(function() {
  ...
  Node = (function() {
    ...
    Node.prototype.render = function() {
      ...
      if (settings.expandable === true && settings.initialState === "collapsed") {
        ...
        this.indenter[0].style.width = "" + (this.level() * settings.indent + 19) + "px";
  ...
  Tree = (function() {
    ...
    Tree.prototype.move = function(node, destination, tableName) {
      // Conditions:
      ...
      //    result in +node+ being an ancestor of itself.
        ...
        try {
            ...
            var url = "/Utils/ChangedNode?\ntableName=" + tableName + params; // code tiếp sau - :D
            var http = null;
  ...
  methods = {
    ...
    loadBranch: function(node, rows) {
      ...
      move: function (nodeId, destinationId, tableName) {
      var destination, node;

      node = this.data("treetable").tree[nodeId];
      destination = this.data("treetable").tree[destinationId];
          this.data("treetable").move(node, destination, tableName);
