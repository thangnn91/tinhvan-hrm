!function (e) {
    ...
    m.support.htmlMenuitem = "HTMLMenuItemElement" in window,
        ...
        m.ui && m.widget || (m.cleanData = (a = m.cleanData, function (e) {
        var t, n, o;
        for (o = 0; null != e[o]; o++){
            n = e[o];
            try { (t = m._data(n, "events")) && t.remove && m(n).triggerHandler("remove") } catch (e) { }
        } a(e)
        }));
    var c = null,
        d = !1,
        ...
        g = {
            ...
            determinePosition: function (e) {
                if (m.ui && m.ui.position)
                    ...
                    var t = this.offset(); t.top += this.outerHeight(), t.left += this.outerWidth() / 2 - e.outerWidth() / 2, e.css(t)
                }
            },
            position: function (e, t, n) {
                ...
                if (t || n) {
                    if ("maintain" === t && "maintain" === n)
                        ...
                        var a = e.$menu.offsetParent().offset(); o = { top: n - a.top, left: t - a.left }
                    }
            ...
            positionSubmenu: function (e) {
                if (void 0 !== e)
                    if (m.ui && m.ui.position) e.css("display", "block").position({ my: "left top-5", at: "right top", of: this, collision: "flipfit fit" }).css("display", "");
                        ...
                        var t = { top: -9, left: this.outerWidth() - 5 }; e.css(t)
                    }
            },
            //position: "fixed",
            zIndex: 1,
            ...
            events: {
                show: m.noop, hide: m.noop, activated: m.noop
            }, callback: null, items: {}
        }, s = {
